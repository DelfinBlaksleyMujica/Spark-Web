      ...
      <section className="relative bg-[#E6E6E6] text-black overflow-hidden pt-[100px]">
        ...
        <div>
          <img
            ...
            alt="Pricin section background pattern 1"
          ...
          <img
            ...
            alt="Pricin section background pattern 2"
          ...
          <img
            ...
            alt="Pricin section background pattern 3"
          ...
          <img
            ...
            alt="Pricin section background pattern 4"
          ...
          <div className="grid grid-cols-12 gap-x-6">
            ...
            >
              ...
              <p className="mt-3 mx-auto max-w-[900px] text-[16px] sm:text-[18px] lg:text-[18px] text-zinc-700">
                Discover trends, tips, and strategies to enhance employee
                engagement, strengthen company culture, and create a more
