...
export default function Hero() {
  return (
    <div className="flex justify-center items-center h-screen w-full bg-white pt-[40px] ">
      <div className="w-full h-full flex justify-center items-center px-[20px] lg:px-[100px]">
        <div className="flex flex-col justify-center items-center max-w-[800px] w-full">
          <h1 className="text-black text-[2rem] md:text-[60px] font-medium leading-[100%] mb-[30px] text-center leading-[100%]">
            Certified Experiences. <br />
            Real Impact.
          </h1>
          <p className="mb-[56px] text-[18px] leading-[136%] tracking-tight text-center text-black">
